...
public class DownloadHelper {
    public static boolean isFileDownloaded(String expectedFileName, String fileExtension, int timeOut) throws IOException, IOException {
        String folderName = PropertiesLoadHelper.loadProperty("download.folder.path");
